# Generated by Powerlevel10k configuration wizard on 2023-05-03 at 17:04 +07.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 19454.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, vertical separators, slanted heads, flat tails, 1 line, sparse, few icons,
# concise, transient_prompt, instant_prompt=auto-quiet.
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=45
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=45
